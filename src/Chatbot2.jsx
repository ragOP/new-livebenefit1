...
export default function Chatbot2() {
  ...
  useEffect(() => {
    const initialMessages = [
      ...
      {
        text: "Mary this side. Let’s find out if you qualify for the Free Health Coverage and $200/month Grocery Allowance Card — it’s quick and only takes 2 minutes!",
        sender: "bot",
